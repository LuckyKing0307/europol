<div class="sm:relative"
    ...
    <div class="bg_black" x-show="linesVisible" x-transition:enter="transition-opacity duration-500"
         x-transition:leave="transition-opacity duration-500"></div>
    ...
    <div
        class="absolute inset-x-0 top-auto z-50 w-screen max-w-sm px-6 py-8 mx-auto mt-4 bg-white border border-gray-100 shadow-xl sm:left-auto rounded-xl basket_data"
        x-show="linesVisible"
        ...
        @else
            <p class="py-4 text-lg font-medium text-center text-gray-500 basket_empty">
                ...
                <span
                    class="py-4 text-lg font-medium text-center text-gray-500">{{ __('cart.empty_subtitle') }}</span>
            </p>
    </div>
