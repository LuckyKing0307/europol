<div class="add_to_cart cart_{{ $productId }}">
    <div class="product_data-qty">
        <button class="product_data-btn product_data-btn--minus " id="minus-btn" wire:click="decrement">−</button>
        <div class="product_data-qty-value">
            {{ number_format($qty_float, 2, '.', ' ') }} м<sup>2</sup>
        </div>
        <button class="product_data-btn product_data-btn--plus plus-btn" id="plus-btn" wire:click="increment">+</button>
    </div>
