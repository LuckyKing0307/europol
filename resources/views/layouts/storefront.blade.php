...
<div class="btns_contacts">
    <a href="tel:+998901234567" class="telegram" target="_blank" rel="noopener">
        <img src="{{ asset('img/contac_phone.png') }}" alt="Позвонить" width="50" height="50" loading="lazy" decoding="async">
    </a>
    <a href="https://t.me/europol_uzbekistan" class="telegram" target="_blank" rel="noopener">
        <img src="{{ asset('img/telegram.png') }}" alt="Telegram" width="50" height="50" loading="lazy" decoding="async">
    </a>
</div>
...
<script type="module">
    ...
    const initAmo = () => {
        (function(a,m,o,c,r,m2){
            a[m2]={id:"430467",hash:"7462463ff36f16ac96d963c482521d04374a712c44e99cbb71f0e91dd62bdcd3",locale:"ru",inline:true,setMeta:function(p){(this.params=this.params||[]).push(p)}};
            a[o]=a[o]||function(){(a[o].q=a[o].q||[]).push(arguments)};
            const d=a.document,s=d.createElement('script'); s.async=true; s.id=m2+'_script';
    ...
    const loadAnalytics = () => {
        (function(){
            const s = document.createElement('script');
            s.src='https://www.googletagmanager.com/gtag/js?id=G-5BLYMWPZ7J'; s.async=true; document.head.appendChild(s);
            window.dataLayer = window.dataLayer || [];
            function gtag(){dataLayer.push(arguments)}; window.gtag = gtag;
            gtag('js', new Date()); gtag('config','G-5BLYMWPZ7J');
        })();
        (function(m,e,t,r,i,k,a){
            m[i]=m[i]||function(){(m[i].a=m[i].a||[]).push(arguments)}; m[i].l=1*new Date();
            k=e.createElement(t),a=e.getElementsByTagName(t)[0];k.async=1;k.src=r;a.parentNode.insertBefore(k,a)
        })(window, document, "script", "https://mc.yandex.ru/metrika/tag.js", "ym");
        ym(103355402, "init", { clickmap:true, trackLinks:true, accurateTrackBounce:true, webvisor:false, ecommerce:"dataLayer" });
        !function(f,b,e,v,n,t,s){if(f.fbq)return;n=f.fbq=function(){n.callMethod?
            n.callMethod.apply(n,arguments):n.queue.push(arguments)}; if(!f._fbq)f._fbq=n;
            n.push=n;n.loaded=!0;n.version='2.0';n.queue=[]; t=b.createElement(e);t.async=!0;
            t.src=v; s=b.getElementsByTagName(e)[0]; s.parentNode.insertBefore(t,s);
        }(window, document,'script','https://connect.facebook.net/en_US/fbevents.js');
        fbq('init','738261772126632'); fbq('track','PageView');
        (function(){
            const dbpr = 100; // процент сэмплинга
            if (Math.random()*100 > 100 - dbpr) {
                const s = document.createElement('script');
                s.async = true; s.src = 'https://cdn.debugbear.com/sP6EEzgCU2rl.js'; document.head.appendChild(s);
                window.dbbRum = window.dbbRum || []; window.dbbRum.push(["presampling", dbpr]);
            }
        })();
        initAmo();
    };
